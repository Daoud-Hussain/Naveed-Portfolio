  ...
  <main>
    ...
    <section class="cs_hero cs_style_3 cs_filled_bg cs_center text-center" data-src="assets/img/bg/hero_bg_4.svg">
      <div class="container">
        ...
        <h1 class="cs_hero_title cs_font_92 cs_black wow fadeInUp" data-wow-duration="0.8s" data-wow-delay="0.2s"><span class="cs_gradient_text">My </span><span
            class="cs_gradient_border_text">Portfolio</span></h1>
        <ol class="breadcrumb">
